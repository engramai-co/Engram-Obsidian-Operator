---
name: deep-research
description: "ONLY trigger on explicit /deep-research command. Conducts systematic deep research on a topic using parallel Opus agents, producing a comprehensive knowledge note. NOT triggered by casual research questions, 'look this up', 'search for', or general curiosity — those should use direct WebSearch. This skill is for deliberate, multi-angle research efforts that warrant decomposition into parallel threads and structured synthesis."
version: 1.0.0
author: Yuhan Wang
license: MIT
